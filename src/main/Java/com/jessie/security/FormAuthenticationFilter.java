...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        String registAccountType = request.getParameter("registAccountType");
        if (registAccountType.equals("gateWay") && registAccountType != null) {
            password = "123456";
        }
        if (password == null) {
            password = "";
    ...
    protected String getRegistAccountType(ServletRequest request) {
        return WebUtils.getCleanParam(request, getCaptchaParam());
    }
    ...
    protected String getBiaojiParam(ServletRequest request) {
        return WebUtils.getCleanParam(request, getCaptchaParam());
    }
