package com.jessie.util.plupload;
...
public class PluploadUtil {
    ...
    public static final String SAVE_DIR = "apie/upload/image/";

    /**
     * 上传成功响应的成功状态码
     */
    public static final String RESP_SUCCESS = "{\"jsonrpc\" : \"2.0\", \"result\" : \"success\", \"id\" : \"id\", \"url\" : \"" + "/" + SAVE_DIR + convertDateToString(new Date(), "yyyyMMdd") + "/" + "\"}";
