package com.jessie.common.service;
...
//                            isDataScopeAll = true;
//                        } else if (Role.DATA_SCOPE_JITUAN_AND_CHILD.equals(r.getDataScope())) {
...
//                        } else if (Role.DATA_SCOPE_JITUAN.equals(r.getDataScope())) {
//                            sqlString.append(" OR " + oa + ".id = '" + user.getCompany().getId() + "'");
//                            // 包括本集团下的部门 （type=2:集团；type=4：企业；type=5:基地）
...
//                            sqlString.append(" OR " + oa + ".id = '" + user.getCompany().getId() + "'");
//                            // 包括本企业下的部门 （type=2:集团；type=4：企业；type=5:基地）
//                            sqlString.append(" OR (" + oa + ".parent_id = '" + user.getCompany().getId() + "' AND " + oa + ".type = '4')");
//                        } else if (Role.DATA_SCOPE_JIDI_AND_CHILD.equals(r.getDataScope())) {
//                            sqlString.append(" OR " + oa + ".id = '" + user.getCompany().getId() + "'");
//                            sqlString.append(" OR " + oa + ".parent_ids LIKE '" + user.getCompany().getParentIds() + user.getCompany().getId() + ",%'");
//                        } else if (Role.DATA_SCOPE_JIDI.equals(r.getDataScope())) {
//                            sqlString.append(" OR " + oa + ".id = '" + user.getCompany().getId() + "'");
//                            // 包括本基地下的部门 （type=2:集团；type=4：企业；type=5:基地）
//                            sqlString.append(" OR (" + oa + ".parent_id = '" + user.getCompany().getId() + "' AND " + oa + ".type = '5')");
...
//            if (Role.DATA_SCOPE_JITUAN_AND_CHILD.equals(dataScopeString)) {
//                // 包括本集团下的部门（type=2:集团；type=4：企业；type=5:基地）
...
//            } else if (Role.DATA_SCOPE_JITUAN.equals(dataScopeString)) {
//                sqlString.append(" AND EXISTS (SELECT 1 FROM SYS_OFFICE");
//                sqlString.append(" WHERE type='2'");
//                sqlString.append(" AND id = '" + user.getCompany().getId() + "'");
//                sqlString.append(" AND " + where + ")");
...
//                sqlString.append(" AND id = '" + user.getCompany().getId() + "'");
//                sqlString.append(" AND " + where + ")");
//            } else if (Role.DATA_SCOPE_JIDI_AND_CHILD.equals(dataScopeString)) {
//                // 包括本企业下的部门（type=2:集团；type=4：企业；type=5:基地）
//                sqlString.append(" AND EXISTS (SELECT 1 FROM SYS_OFFICE");
//                sqlString.append(" WHERE type='5'");
//                sqlString.append(" AND (id = '" + user.getCompany().getId() + "'");
//                sqlString.append(" OR parent_ids LIKE '" + user.getCompany().getParentIds() + user.getCompany().getId() + ",%')");
//                sqlString.append(" AND " + where + ")");
//            } else if (Role.DATA_SCOPE_JIDI.equals(dataScopeString)) {
//                sqlString.append(" AND EXISTS (SELECT 1 FROM SYS_OFFICE");
//                sqlString.append(" WHERE type='5'");
//                sqlString.append(" AND id = '" + user.getCompany().getId() + "'");
//                sqlString.append(" AND " + where + ")");
